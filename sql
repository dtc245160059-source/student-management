...
-- Bước 4: Tạo bảng GiaoVien (tạo trước để tiện tham chiếu khóa ngoại)
...
-- Bước 6: Thêm ràng buộc khóa ngoại cho bảng MonHoc tham chiếu đến bảng GiaoVien
ALTER TABLE MonHoc 
ADD CONSTRAINT FK_MaGV FOREIGN KEY (MaGV) REFERENCES GiaoVien(MaGV);

-- Bước 7: Tạo bảng BangDiem (Bảng trung gian quản lý quan hệ N - N)
